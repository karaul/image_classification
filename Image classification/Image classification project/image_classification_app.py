...
class ImageClassificationer:
    ...
    @staticmethod
    def image_classificationer(search, model_name="image_classificationer_model.h5", image_path="./"):
...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.label = QtWidgets.QLabel("Welcome to Maskiiw Image Classification")
